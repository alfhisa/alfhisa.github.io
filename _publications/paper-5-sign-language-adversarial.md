...
slidesurl: ''
paperurl: 'https://ieeexplore.ieee.org/abstract/document/11329865/'
citation: 'Saputra, M. A., Heryadi, Y., Sonata, I., Wulandhari, L. A., & Girsang, A. S. (2025, October). Evaluating the Adversarial Vulnerability of YOLOv11 for Indonesian Sign Language (BISINDO) Recognition. In 2025 8th International Conference on Informatics and Computational Sciences (ICICoS) (pp. 241-246). IEEE.'
---
