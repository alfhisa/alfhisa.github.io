...
permalink: /teaching/web-design-stjohn
...
This tutorial is designed for **beginners (SMA level)** and guides you **step by step** from zero until you successfully build a **CRUD (Create, Read, Update, Delete)** web application using **PHP and MySQL** on **macOS** with **MAMP**.
